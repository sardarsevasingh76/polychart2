...
(function() {
  ...
  poly.touch = function(type, obj, event, graph) {
    var e, elem, end, first, i, j, offset, possibleEvents, start, touch, touchList, touchPos, touchTime, touchType, _i, _j, _k, _ref, _ref1, _ref2, _updatePt;
    ...
    if (type === 'touchstart') {
      ...
      return event.view.setTimeout((function() {
        return ['mover'];
      }), 500);
      ...
      if (event.timeStamp - touchInfo.lastStart > 500) {
        if (elem.isPointInside(touchPos.x, touchPos.y)) {
          return ['touchmove', 'mover'];
        } else {
          return ['touchmove', 'mout'];
        }
      } else {
        return ['touchmove'];
      }
      ...
      for (i = _j = 0, _ref1 = touchList.length - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
        ...
        _updatePt(end, touch);
        for (j = _k = _ref2 = touchInfo.touches.length - 1; _ref2 <= 0 ? _k <= 0 : _k >= 0; j = _ref2 <= 0 ? ++_k : --_k) {
      ...
      if (__indexOf.call(possibleEvents, 'mouseover') < 0) {
        return ['reset', 'mout'];
      } else if (__indexOf.call(possibleEvents, 'mouseover') >= 0 && touchType === 'tap') {
        return ['mout', 'click'];
      } else {
        return ['mout'];
      }
...
(function() {
  var Area, CustomScale, Gradient, Gradient2, Identity, Linear, Log, Opacity, Palette, PositionScale, Scale, Shape,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  */
  ...
  Line = (function(_super) {
    ...
    Line.prototype.attr = function(scales, coord, offset, mark, mayflip) {
      ...
      _ref3 = this._checkArrayNaN(x, y), x = _ref3.x, y = _ref3.y;
      stroke = this._maybeApply(scales, mark, mark.stroke ? 'stroke' : 'color');
      size = this._maybeApply(scales, mark, mark.size ? 'size' : 'stroke-width');
      return this._shared(scales, mark, {
        path: this._makePath(x, y),
...
(function() {
  ...
  */
  ...
  poly.handler.zoom = function(init_spec, zoomOptions) {
    ...
    return function(type, obj, event, graph) {
      var aesVar, data, guides, layer, v, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3, _ref4, _ref5, _ref6, _results;
      ...
      if (graph.coord.type === 'cartesian') {
        if (type === 'resetZoom') {
          for (_i = 0, _len = aes.length; _i < _len; _i++) {
            v = aes[_i];
            graph.spec.guides[v] = _.clone(initGuides[v]);
          }
    ...
    */
    ...
    Graph.prototype.handleEvent = function(type) {
      ...
      handler = function(event) {
        var adjEnd, adjStart, adjusted, col, end, evtData, f1, h, obj, row, start, t, _i, _len, _ref, _results, _type;
        obj = this;
        _type = [type];
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push((function() {
            var _j, _len1, _results1;
            _results1 = [];
            for (_j = 0, _len1 = _type.length; _j < _len1; _j++) {
              t = _type[_j];
              if (_.isFunction(h)) {
                _results1.push(h(t, obj, event, graph));
              } else {
                _results1.push(h.handle(t, obj, event, graph));
              }
            }
            return _results1;
          })());
